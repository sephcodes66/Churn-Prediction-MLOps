...
def test_sensor_data_outliers():
    ...
    """
    # 1. Setup: Create a sample DataFrame with sensor data, including outliers.
    data = {
    ...
    # 2. Execution: Use DuckDB to run a SQL query to find outliers.
    # An outlier is defined as a value that is 50 times greater than the median.
    result = duckdb.query("""
    WITH stats AS (
        SELECT
    ...
    # 3. Assertion: Verify that the correct number of outliers were detected.
